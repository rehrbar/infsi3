...
\textbf{Apache SSL Cipher Hardening}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.38\textwidth]{./img/apache_ssl_configuration.png}
	\caption{Apache SSL Configuraiton}
\end{figure}
\textbf{Apache SSL Cipher Forwarding}
...
Der Appache leitet dann die SSL Informationen zu der Applikation,  via dem mod_header weiter, welche dann den entscheid für die entsprechende SSL Cipher Suit macht.
\begin{easylist}
	& Applikation muss die Cipher prüfen
	& Bei änderunge oder neuen Cipher muss die Applikation neu konfiguriert werden.
\end{easylist}	
